---
name: journal
description: Use when the user runs the journal slash command with `accept`, `skip`, or `edit` (e.g. `/journal accept`) to act on pending claude-journal proposals (new skills, feedback memories, or CLAUDE.md edits surfaced at SessionStart).
---
